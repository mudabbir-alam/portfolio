        ...
        <footer className=" border-t border-t-border w-full py-12">
            <div className="flex justify-between max-w-300 px-6 mx-auto items-center flex-col gap-4 sm:flex-row">
                ...
                <div className="text-sm text-slate-500">
                  &copy; {new Date().getFullYear()} Mudabbir Alam. All rights reserved.
                </div>
                <div className="flex gap-4 text-xl text-slate-500">
                    <span className="material-symbols-outlined hover:text-blue-p hover:cursor-pointer">hub</span>
                    <span className="material-symbols-outlined hover:text-blue-p hover:cursor-pointer">alternate_email</span>
                </div>
            </div>
        </footer>
    );
